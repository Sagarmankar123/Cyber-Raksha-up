...
public class OnboardingActivity extends AppCompatActivity {
    ...
    private void showNextCard() {
        ...
        switch (currentStep) {
            ...
            case 5:
                ...
                desc.setText("Grant Notification Access so CyberRaksha's Dynamic Island can show calls, music, WhatsApp messages, timers — like iPhone Dynamic Island!");
                btn.setText("GRANT NOTIFICATION ACCESS");
                btn.setOnClickListener(v -> {
                    if (IslandNotificationService.isPermissionGranted(this)) {
                        currentStep++;
                        showNextCard();
                    } else {
            ...
            case 6:
                ...
                desc.setText("CyberRaksha Dynamic Island is fully activated! It will show calls, music, messages, and fraud alerts above every app.");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 201) {
            ...
            // Notification Access result — advance regardless (user may have granted it)
            currentStep++;
            showNextCard();
        }
    }
