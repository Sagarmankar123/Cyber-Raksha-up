...
public class AppAdapter extends RecyclerView.Adapter<AppAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (holder.cardRoot instanceof CardView) {
            CardView card = (CardView) holder.cardRoot;
            CardView badgeCard = holder.itemView.findViewById(R.id.riskBadgeCard);
            ...
            if (info.riskLevel.contains("HIGH")) {
                ...
                card.setCardBackgroundColor(ContextCompat.getColor(context, R.color.risk_high));
            } else if (info.riskLevel.contains("MEDIUM")) {
                colorRes = R.color.risk_medium;
                card.setCardBackgroundColor(ContextCompat.getColor(context, R.color.risk_medium));
            } else {
                colorRes = R.color.status_safe;
                card.setCardBackgroundColor(ContextCompat.getColor(context, R.color.backgroundColor));
            }
